...
namespace Brunfjell.Controllers
{
    ...
    {
        private readonly BrunfjellContext _context;

        public GalleriesController(BrunfjellContext context)
        {
            _context = context;
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Title,ReleaseDate,Genre,Price")] Gallery gallery)
        {
            if (id != gallery.Id)
            {
                return NotFound();
